 ...
 *
 * @param {object} formulaire Le formulaire contenant les donnÃ©e du personnage Ã  ajouter
...
/**
 * Affiche Ã  l'Ã©cran les personnages ajoutÃ©s dans le array
 */
function afficherPersonnages() {
    if(personnages.length < 1){
        ...
        let buttonDiv = document.getElementById("boutonsPersonnages");
        let newString = "";
        for(let i = 0 ; i < personnages.length ; i++) {
            newString += "<p>" + personnages[i][0] + " " + personnages[i][2] + "</p>";
        }
...
/**
 * Supprime du array les personnages ajoutÃ©s
 */
